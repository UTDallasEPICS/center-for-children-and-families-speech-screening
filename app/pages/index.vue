  ...
  <div>
      ...
      <div class="mx-auto max-w-7xl px-6 py-4">
        <div class="flex items-center justify-center">
          ...
          <template v-for="(step, i) in steps" :key="step">
            ...
            >
              <div
                class="flex h-6 w-6 items-center justify-center rounded-full text-xs font-bold transition-all duration-200"
                :class="
                  currentStep === i
                    ? 'bg-white/20'
                    : currentStep > i
    ...
    <div class="mx-auto w-full max-w-7xl px-6 py-10">
      ...
      <div v-if="currentStep === 1">
        <div
          class="mb-6 flex items-center justify-between rounded-xl border border-gray-200 bg-white p-4"
        >
          <div class="flex items-center gap-3">
            <div class="flex h-10 w-10 items-center justify-center rounded-lg bg-green-50">
              <UIcon name="i-heroicons-check-circle" class="text-xl text-[#8DC63F]" />
            </div>
            <!--file info-->
            <div>
        ...
        <div class="overflow-hidden rounded-xl border border-gray-200 bg-white">
          ...
          >
            ...
            <div class="flex gap-3">
              ...
              <UButton
                class="bg-[#0077C0] transition-all duration-150 hover:bg-[#005a94] active:scale-95"
                disabled
              >
