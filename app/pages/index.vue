<template>
  ...
  <div class="mx-auto w-full max-w-7xl px-6 py-10">
    ...
    <div v-if="currentStep === 0">
      ...
      <div
        ...
        :class="
          dragOver
            ...
            : 'hover:border-main-blue border-gray-300 hover:shadow-md'
        "
      ...
      >
        ...
        <div class="flex flex-col items-center gap-4">
          ...
          <div
            class="flex-center-center transition-ease h-16 w-16 rounded-2xl"
          ...
          <UButton
            class="bg-main-blue hover:bg-off-main-blue mt-2 active:scale-95"
      ...
      <div class="flex-center-center footnote-text mt-4 gap-2">
      ...
      <div class="white-background-border overflow-hidden">
        ...
        <div class="bottom-header flex-center-JusBetween">
          ...
          <div class="flex gap-3">
            ...
            <UButton class="forward-button" @click="calculateData">
    ...
    <div v-if="currentStep === 2">
      <div class="white-background-border flex-center-center mb-6 p-4">
    ...
    <div v-if="currentStep === 3">
      <div class="white-background-border flex-center-center mb-3 p-3">
      ...
      <div class="white-background-border overflow-hidden">
        ...
        <div class="white-background-border bottom-header flex-center-JusBetween">
          ...
          <div class="flex-center-center gap-2">
            ...
            <UButton> Download Data Excel </UButton>
          </div>
        </div>
      </div>
    </div>
